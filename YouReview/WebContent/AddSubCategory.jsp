			...
			<div class="main-login main-center" style="max-width: 830px;">
				<form class="form-horizontal" method="post"
					...
					<div class="form-group">
						...
						<div class="cols-sm-5">
							<div class="input-group">
								<span class="input-group-addon"><b>How is </b></span> <input
									type="text" class="form-control" name="Question1"
									id="Question1" placeholder="Enter Question Keyword" /> <span
									class="input-group-addon"><b>?</b></span>
							</div>
						</div>
						...
						<div class="cols-sm-5">
							<div class="input-group">
								<span class="input-group-addon"><b>How is </b></span> <input
									type="text" class="form-control" name="Question2"
									id="Question2" placeholder="Enter Question Keyword" /> <span
									class="input-group-addon"><b>?</b></span>
							</div>
						</div>
						...
						<div class="cols-sm-5">
							<div class="input-group">
								<span class="input-group-addon"><b>How is </b></span> <input
									type="text" class="form-control" name="Question3"
									id="Question3" placeholder="Enter Question Keyword" /> <span
									class="input-group-addon"><b>?</b></span>
							</div>
						</div>
						...
						<div class="cols-sm-5">
							<div class="input-group">
								<span class="input-group-addon"><b>How is </b></span> <input
									type="text" class="form-control" name="Question4"
									id="Question4" placeholder="Enter Question Keyword" /> <span
									class="input-group-addon"><b>?</b></span>
							</div>
						</div>
						...
						<div class="cols-sm-5">
							<div class="input-group">
								<span class="input-group-addon"><b>How is </b></span> <input
									type="text" class="form-control" name="Question5"
									id="Question5" placeholder="Enter Question Keyword" /> <span
									class="input-group-addon"><b>?</b></span>
							</div>
						</div>
